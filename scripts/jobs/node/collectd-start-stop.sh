...
NAME=collectd
DAEMON=$COLLECTD_HOME/sbin/collectd
CONFIGFILE=$COLLECTD_NODE_HOME/collectd.conf
PIDFILE=$COLLECTD_NODE_HOME/collectd.pid

USE_COLLECTDMON=1
COLLECTDMON_DAEMON=$COLLECTD_HOME/sbin/collectdmon
